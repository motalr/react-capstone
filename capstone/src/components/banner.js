        ...
        <>
            <section className="hero">
                <div className="hero-content">
                    ...
                    <a href="/reservation" className="focus:outline-none text-black bg-yellow-400 hover:bg-yellow-500 focus:ring-4 focus:ring-yellow-300  rounded-lg text-m px-5 py-2.5 me-2 mb-2 dark:focus:ring-yellow-900">Reserve a Table</a>
                </div>
